...
def plot_batchSize_vs_packetRate():
    ...
    for b_size in range(20, 150, 20):
        for p_rate in range(2500, 8000, 1000):
            ...
            file_name = f'/home/seed/Desktop/DEFT/plot_experiments/bsize_prate/batch_20-gf_1-buf_1-pktrate_2500-flow_cnt_1-stamper_cnt_1.csv'
    ...
    # new code start
    output_path = 'plots/batch_size_vs_pkt_rate/latency.pdf'
    ...
    # new code start
    output_path = 'plots/batch_size_vs_pkt_rate/latency2.pdf'
    ensure_dir(output_path)
    fig.savefig(output_path, format='pdf', dpi=1200)
    # new code end
    ...
    # new code start
    output_path = 'plots/batch_size_vs_pkt_rate/throughput.pdf'
    ensure_dir(output_path)
    fig.savefig(output_path, format='pdf', dpi=1200)
    ...
    # new code start
    output_path = 'plots/batch_size_vs_pkt_rate/throughput_kpps.pdf'
    ensure_dir(output_path)
    fig.savefig(output_path, format='pdf', dpi=1200)
    # new code end
    ...
    # new code start
    output_path = 'plots/batch_size_vs_pkt_rate/packets_dropped.pdf'
    ensure_dir(output_path)
    fig.savefig(output_path, format='pdf', dpi=1200)
    # new code end
